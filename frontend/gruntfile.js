module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {   
            dist: {
                src: [
                    'js/fixedheightcarousel.jqueryplugin.js',
                ],
                dest: "compiled/concat/js/fixedheightcarousel.jqueryplugin.js"
            }
        },
        ...
        uglify: {
            build: {
                files: {
                    'compiled/uglify/js/fixedheightcarousel.jqueryplugin.min.js': ['compiled/concat/js/fixedheightcarousel.jqueryplugin.js']
                }
            }
        },
        copy: {
