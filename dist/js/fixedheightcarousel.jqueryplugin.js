...
;(function ( $, window, document, undefined ) {
    ...
    function FixedHeightCarousel( element, options ) {
        this.element = element;

        $(this.element).data('fixedHeightCarousel', this);
        ...
        this.slide_container_outer = null;
    ...
    FixedHeightCarousel.prototype = {
        ...
        initContainers: function(){
            ...
            $(this.original_slide_container).children("li").each(function(index, item){
                ...
                $(slide).bind(SlideImage.EVENT_LOAD_COMPLETE, function(event){
                    ...
                    var slide_html = parent.createSlide(slide);
                    $(parent.slide_container).append(slide_html); 
            ...
            this.slide_container_outer = $("<div class='slide-container-outer' />");
            $(this.element).append(this.slide_container_outer);
            $(this.slide_container_outer).append(this.slide_container);
        ...
        resizeContainers: function(){
            ...
            $(this.slide_container).children().each(function(index, item){
                ...
                var slide = parent.all_images_index_hash[index];
    ...
    $.fn[pluginName] = function ( options ) {
        return this.each(function () {
            if (!$.data(this, "plugin_" + pluginName)) {
                ...
                new FixedHeightCarousel( this, options ));
            }
        });
    };
...
SlideImage.prototype.get_width_for_height = function (height) {
    if(this.loaded == false){
        return 0;
    }
    return this.original_aspect_ratio * height;
};
